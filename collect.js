// 跨店率每日结算脚本：每天凌晨跑一次，算出"昨天"回兴店的跨店率，追加一条记录到 history.json/history.js。
//
...
//
// 分母/分子算法跟 backfill.js 共用同一份逻辑（见 lib.js），保证每天新增的数据点
...
const { beijingDateStr, buildCardIntervals, denominatorOnDate, computeNumeratorForDate } = require("./lib.js");
